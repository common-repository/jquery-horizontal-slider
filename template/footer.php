...
<li><img src="<?php echo plugins_url('', __FILE__); ?>/icono3.png" width="50" height="50" /> <span class="style5"><strong><em>SEO</em></strong>. </span><span class="style3">The title of each image. </span></li>
...
<hr />
<p><strong>You can enter the url of the images manually or press the button "change image". Pressing the button will load the library wordpress images, select the image you want and click "Insert in Post" to insert the image in the slider.</strong>
</p>
<p>&nbsp;   </p>
...
<p>&nbsp;</p>
<p class="style6"><a href="http://www.pluginswp.com/">Visit our page and see more premium plugins!</a></p>
